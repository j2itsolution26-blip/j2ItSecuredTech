...
export const metadata = buildMetadata({
  ...
  description:
    'J2 SecureTech delivers enterprise software, websites and e-commerce, CCTV and biometric security, structured cabling, networks and cloud services for organisations across the Philippines.',
  path: '/',
});
