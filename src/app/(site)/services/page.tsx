...
export const metadata = buildMetadata({
  ...
  description:
    'Enterprise software development, website and e-commerce builds, CCTV and biometric security, structured cabling, networking, cloud and managed IT support from J2 SecureTech.',
  path: '/services',
});
