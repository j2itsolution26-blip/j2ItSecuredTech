import {
  Activity, ArrowRight, Boxes, Building2, Camera, Cctv, CheckCircle2, Cloud, Code2, Cpu,
  Database, Factory, FileCheck, Fingerprint, Gauge, Globe, GraduationCap, Handshake,
  HardDrive, Headset, Hotel, Landmark, Laptop, Layers, Lock, MonitorSmartphone, Network,
  Package, Radio, Router, Server, ServerCog, Settings2, Shield, ShieldCheck, ShoppingBag,
  ShoppingCart, Stethoscope, Truck, Users, Wifi, Wrench, Zap,
  type LucideIcon,
} from 'lucide-react';
